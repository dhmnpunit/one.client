                    ...
                    {selectedProject.teamMembers.length > 0 ? (
                      <div className="space-y-3">
                        {selectedProject.teamMembers.map((member) => (
                          <div key={member} className="flex items-center p-2 hover:bg-gray-50 rounded-md">
                            <Avatar className="h-10 w-10 mr-3 border border-gray-200">
                              <AvatarImage 
                                src={`https://api.dicebear.com/7.x/micah/svg?seed=${member.toLowerCase().replace(/\s+/g, '-')}`} 
                                alt={member} 
                              />
                              <AvatarFallback>{member.charAt(0)}</AvatarFallback>
                            </Avatar>
                      ...
                      <p className="text-sm text-gray-500 py-2">No team members assigned to this project yet.</p>
                    )}
                  </div>
