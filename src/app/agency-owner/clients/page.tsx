...
export default function ClientsPage() {
  ...
  const maxClients = 10; // Maximum allowed clients
  const totalRevenue = 12500; // Placeholder for total revenue
  const teamMembers = 4; // Number of team members
  const clientsPerMember = (totalClients / teamMembers).toFixed(1); // Clients per member ratio
